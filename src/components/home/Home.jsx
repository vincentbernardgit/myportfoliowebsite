...
export default function Home() {
    const getCv = (e) => {
        ...
        Swal.fire({
            ...
            confirmButtonText: '<a href="assets/cv.pdf" download="CV_Vincent Bernard updated December 2021" style="text-decoration: none; color: white;">Best CV :)</a>',
            cancelButtonText: '<a href="assets/ATS-friendly CV_Vincent Bernard.docx" style="text-decoration: none; color: white;">ATS-friendly CV</a>'
        })
    };
    ...
    return (
        <div className="home" id="home">
            <div className="left">
                ...
                <p>&lt;p&gt;</p>
                <h6>Front End Developer / Back End Developer</h6>
                <p>&lt;/p&gt;</p>
